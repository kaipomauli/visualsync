...
wget https://download.europe.naverlabs.com/ComputerVision/MASt3R/MASt3R_ViTLarge_BaseDecoder_512_catmlpdpt_metric.pth ./preprocess/pretrained/MASt3R_ViTLarge_BaseDecoder_512_catmlpdpt_metric.pth